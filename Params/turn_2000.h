...
const static t_pid_gain sp_gain_turn90_2000 = {4.0,0.05,0.00};
...
const static t_pid_gain sp_gain_turn180_2000 = {4.0,0.05,0.00};;
...
//k = 300
//not adjust
const static t_pid_gain sp_gain_turnV90_2000 = {4.0,0.05,0.00};;
...
//k = 300
const static t_pid_gain sp_gain_turnIn45_2000 = {4.0,0.05,0.00};;
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_2000 = {4.0,0.05,0.00};;
...
const static t_pid_gain sp_gain_turnIn135_2000 = {4.0,0.05,0.00};;
...
//
const static t_pid_gain sp_gain_turnOut135_2000 = {4.0,0.05,0.00};;
