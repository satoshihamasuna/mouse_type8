...
const static t_pid_gain sp_gain_turn90_2000 = {3.0,0.05,0.00};;
const static t_pid_gain om_gain_turn90_2000 = {0.10f,0.005f,0.0f};
...
const static t_pid_gain sp_gain_turn180_2000 = {3.0,0.05,0.00};;
const static t_pid_gain om_gain_turn180_2000 = {0.10f,0.005f,0.0f};
const static t_turn_param_table slalom_L180_2000_table = {2.00f, 47.0f,7.28,33.08, 180.0f,Turn_L};
const static t_turn_param_table slalom_R180_2000_table = {2.00f,-47.0f,7.28,33.08,-180.0f,Turn_R};
...
//k = 300
//not adjust
const static t_pid_gain sp_gain_turnV90_2000 = {3.0,0.05,0.00};;
const static t_pid_gain om_gain_turnV90_2000 = {0.10f,0.005f,0.0f};
...
//k = 300
const static t_pid_gain sp_gain_turnIn45_2000 = {3.0,0.05,0.00};;
const static t_pid_gain om_gain_turnIn45_2000 = {0.10f,0.005f,0.0f};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_2000 = {3.0,0.05,0.00};;
const static t_pid_gain om_gain_turnOut45_2000 = {0.10f,0.005f,0.0f};
...
const static t_pid_gain sp_gain_turnIn135_2000 = {3.0,0.05,0.00};;
const static t_pid_gain om_gain_turnIn135_2000 = {0.10f,0.005f,0.0f};//{0.7f, 0.7f, 0.0f};
...
//
const static t_pid_gain sp_gain_turnOut135_2000 = {3.0,0.05,0.00};;
const static t_pid_gain om_gain_turnOut135_2000 = {0.10f,0.005f,0.0f};
