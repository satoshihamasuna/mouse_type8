...
const static t_pid_gain om_gain_turn90_1800 = {0.2, 0.01, 0.001};
...
const static t_pid_gain om_gain_turn180_1800 = {0.3, 0.01, 0.0};
...
const static t_pid_gain om_gain_turnV90_1800 = {0.3, 0.01, 0.0};
...
const static t_pid_gain om_gain_turnIn45_1800 = {0.3, 0.01, 0.0};
...
const static t_pid_gain om_gain_turnOut45_1800 = {0.3, 0.01, 0.0};
...
const static t_pid_gain om_gain_turnIn135_1800 = {0.3, 0.01, 0.0};//{0.7f, 0.7f, 0.0f};
...
const static t_pid_gain om_gain_turnOut135_1800 = {0.3, 0.01, 0.0};
