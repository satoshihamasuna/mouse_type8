...
const static t_pid_gain om_gain_turnV90_1800 = {0.6, 0.01, 0.0};
...
const static t_turn_param_table slalom_outL45_1800_table = {1.80f, 60.0f,18.81,22.01, 45.0f,Turn_L};
const static t_turn_param_table slalom_outR45_1800_table = {1.80f,-60.0f,18.81,22.01,-45.0f,Turn_R};
