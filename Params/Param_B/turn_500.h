...
const static t_pid_gain sp_gain_turn90_500 = {3.0,0.05,0.0};
...
const static t_pid_gain sp_gain_turn180_500 = {3.0,0.05,0.0};
...
const static t_pid_gain sp_gain_turnV90_500 = {3.0,0.05,0.0};
...
const static t_pid_gain sp_gain_turnIn45_500 = {3.0,0.05,0.0};
...
const static t_pid_gain sp_gain_turnOut45_500 = {3.0,0.05,0.0};
...
const static t_pid_gain sp_gain_turnIn135_500 = {3.0,0.05,0.0};
...
const static t_pid_gain sp_gain_turnOut135_500 = {3.0,0.05,0.0};
