...
const static t_pid_gain om_gain_turn90_1400 = {0.20f,0.01f,0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turn180_1400 = {4.0, 0.05, 0.00};
const static t_pid_gain om_gain_turn180_1400 = {0.20f,0.01f,0.0f};
...
//not adjust
//k = 250
const static t_pid_gain sp_gain_turnV90_1400 = {4.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnV90_1400 = {0.20f,0.01f,0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turnIn45_1400 = {4.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnIn45_1400 = {0.20f,0.01f,0.0f};
...
//k = 220
//k = 250
const static t_pid_gain sp_gain_turnOut45_1400 = {4.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnOut45_1400 = {0.20f,0.01f,0.0f};
...
//k= 250
const static t_pid_gain sp_gain_turnIn135_1400 = {4.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnIn135_1400 = {0.20f,0.01f,0.0f};//{0.7f, 0.7f, 0.0f};
...
//220
const static t_pid_gain sp_gain_turnOut135_1400 = {4.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnOut135_1400 = {0.20f,0.01f,0.0f};
