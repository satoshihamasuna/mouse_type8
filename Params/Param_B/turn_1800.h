...
const static t_pid_gain om_gain_turn90_1800 = {0.20f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turn180_1800 = {0.20f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnV90_1800 = {0.20f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnIn45_1800 = {0.20f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnOut45_1800 = {0.20f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnIn135_1800 = {0.20f,0.01f,0.0f};//{0.7f, 0.7f, 0.0f};
...
const static t_pid_gain om_gain_turnOut135_1800 = {0.20f,0.01f,0.0f};
