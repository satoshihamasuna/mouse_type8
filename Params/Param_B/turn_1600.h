...
//k = 250
const static t_pid_gain sp_gain_turn90_1600 = {4.0,0.05,0.0};
...
//k = 250
const static t_pid_gain sp_gain_turn180_1600 ={4.0,0.05,0.0};
const static t_pid_gain om_gain_turn180_1600 = {0.20, 0.01f, 0.0};
const static t_turn_param_table slalom_L180_1600_table = {1.60f, 48.0f,8.80,30.10, 180.0f,Turn_L,-1.5f};
const static t_turn_param_table slalom_R180_1600_table = {1.60f,-48.0f,8.80,30.10,-180.0f,Turn_R,1.5f};
...
//k = 250
const static t_pid_gain sp_gain_turnV90_1600 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnV90_1600 = {0.20f,0.01f,0.0f};
...
const static t_turn_param_table slalom_LV90_1600_table = {1.60f, 40.0f,4.79,24.95, 90.0f,Turn_L,-1.5f};
const static t_turn_param_table slalom_RV90_1600_table = {1.60f,-40.0f,4.79,24.95,-90.0f,Turn_R,1.5f};
...
//k = 250
const static t_pid_gain sp_gain_turnIn45_1600 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnIn45_1600 = {0.20f,0.01f,0.0f};
...
const static t_turn_param_table slalom_inL45_1600_table = {1.60f, 55.0f,7.52,39.62, 45.0f,Turn_L,-1.5f};
const static t_turn_param_table slalom_inR45_1600_table = {1.60f,-55.0f,7.52,39.62,-45.0f,Turn_R,1.5f};
...
//k = 250
const static t_pid_gain sp_gain_turnOut45_1600 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnOut45_1600 = {0.20f,0.01f,0.0f};
...
const static t_turn_param_table slalom_outL45_1600_table = {1.60f, 60.0f,21.06,20.07, 45.0f,Turn_L,-1.5f};
const static t_turn_param_table slalom_outR45_1600_table = {1.60f,-60.0f,21.06,20.07,-45.0f,Turn_R,1.5f};
...
//k = 250,alpha = 1.0
const static t_pid_gain sp_gain_turnIn135_1600 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnIn135_1600 = {0.20f,0.01f,0.0f};//{0.7f, 0.7f, 0.0f};
...
const static t_turn_param_table slalom_inL135_1600_table = {1.60f, 42.50f,8.23,14.76, 135.0f,Turn_L,-1.5f};
const static t_turn_param_table slalom_inR135_1600_table = {1.60f,-42.50f,8.23,14.76,-135.0f,Turn_R,1.5f};
...
//k = 250
const static t_pid_gain sp_gain_turnOut135_1600 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnOut135_1600 = {0.20f,0.01f,0.0f};
...
const static t_turn_param_table slalom_outL135_1600_table = {1.60f, 41.0f,8.09,37.73, 135.0f,Turn_L,-1.5f};
const static t_turn_param_table slalom_outR135_1600_table = {1.60f,-41.0f,8.09,37.73,-135.0f,Turn_R,1.5f};
