...
//k = 250
const static t_pid_gain sp_gain_turn90_1500 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turn90_1500 = {0.20f,0.01f,0.0f};
...
const static t_pid_gain sp_gain_turn180_1500 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turn180_1500 = {0.20f,0.01f,0.0f};
...
//k = 400
//not adjust
const static t_pid_gain sp_gain_turnV90_1500 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnV90_1500 = {0.20f,0.01f,0.0f};
...
//k = 300
const static t_pid_gain sp_gain_turnIn45_1500 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnIn45_1500 = {0.20f,0.01f,0.0f};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_1500 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnOut45_1500 = {0.20f,0.01f,0.0f};
...
//k = 250 , Kp = 4.0
const static t_pid_gain sp_gain_turnIn135_1500 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnIn135_1500 = {0.20f,0.01f,0.0f};//{0.7f, 0.7f, 0.0f};
...
//
const static t_pid_gain sp_gain_turnOut135_1500 = {4.0,0.05,0.0};
const static t_pid_gain om_gain_turnOut135_1500 = {0.20f,0.01f,0.0f};
