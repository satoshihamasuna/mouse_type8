...
const static t_pid_gain basic_sp_gain = {4.5,0.05,0.0};
const static t_pid_gain basic_om_gain = {0.08f,0.008f,0.00f};//{0.10f, 0.01f, 0.00f};

const static t_pid_gain search_sp_gain = {4.0,0.05,0.00};
const static t_pid_gain search_om_gain = {0.1f, 0.01f, 0.00f};

const static t_pid_gain sp_gain_search_turn = {3.0,0.05,0.00};;//{12.0,0.1,0.0};
const static t_pid_gain om_gain_search_turn = {0.1f, 0.01f, 0.00f};//{0.50f, 0.0005f, 0.001f};
