...
const static t_pid_gain basic_sp_gain = {1.0,0.05,0.01};
const static t_pid_gain basic_om_gain = {0.1f,0.005f,0.00f};//{0.10f, 0.01f, 0.00f};

const static t_pid_gain search_sp_gain = {1.0,0.05,0.0};
...
const static t_pid_gain sp_gain_280 = {1.0,0.08,0.01};
...
const static t_pid_gain sp_gain_300 = {1.0,0.05,0.01};
...
const static t_pid_gain sp_gain_320 = {1.0,0.05,0.0};
...
const static t_pid_gain sp_gain_450 = {1.0,0.05,0.0};
...
const static t_pid_gain sp_gain_500 = {2.5,0.1,0.01};
...
const static t_pid_gain sp_gain_600 = {2.5,0.1,0.01};
