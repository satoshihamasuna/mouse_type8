...
const static t_pid_gain basic_sp_gain = {2.0,0.1,0.05};
const static t_pid_gain basic_om_gain = {0.08f,0.005f,0.00f};//{0.10f, 0.01f, 0.00f};

const static t_pid_gain search_sp_gain = {4.0,0.1,0.0};
const static t_pid_gain search_om_gain = {0.10f, 0.005f, 0.0f};

const static t_pid_gain sp_gain_search_turn = {2.0,0.12,0.00};;//{2.0,0.04};
...
const static t_pid_gain sp_gain_280 = {3.0,0.08,0.0};
...
const static t_pid_gain sp_gain_300 = {2.0,0.2,0.0};
...
const static t_pid_gain sp_gain_320 = {2.0,0.2,0.01};
...
const static t_pid_gain sp_gain_450 = {2.0,0.2,0.01};
...
const static t_pid_gain sp_gain_500 = {3.0,0.02,0.0};
