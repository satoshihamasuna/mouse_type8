...
const static t_turn_param_table slalom_inL135_1800_table = {1.80f, 43.0f,22.85,34.81, 135.0f,Turn_L};
const static t_turn_param_table slalom_inR135_1800_table = {1.80f,-43.0f,22.85,34.81,-135.0f,Turn_R};
