...
const static t_turn_param_table slalom_L90_1800_table = {1.80f, 52.0f,13.79,30.61, 90.0f,Turn_L};
const static t_turn_param_table slalom_R90_1800_table = {1.80f,-52.0f,13.79,30.61,-90.0f,Turn_R};
#else
...
#if PARAM_A_USE_PINK_LED_TURN_LENGTHS
// Pink LED interval (20260725 videos, R median copied to L/R; raw Lstart -1.46 mm clamped to zero).
const static t_turn_param_table slalom_LV90_1800_table = {1.80f, 40.0f,0.00,29.46, 90.0f,Turn_L};
const static t_turn_param_table slalom_RV90_1800_table = {1.80f,-40.0f,0.00,29.46,-90.0f,Turn_R};
#else
...
#if PARAM_A_USE_PINK_LED_TURN_LENGTHS
// Pink LED interval (20260725 Lstart=Lend=0 videos, R median copied to L/R).
const static t_turn_param_table slalom_inL45_1800_table = {1.80f, 53.0f,4.72,43.94, 45.0f,Turn_L};
const static t_turn_param_table slalom_inR45_1800_table = {1.80f,-53.0f,4.72,43.94,-45.0f,Turn_R};
#else
...
#if PARAM_A_USE_PINK_LED_TURN_LENGTHS
// Pink LED interval (20260725 Lstart=Lend=0 videos, R median copied to L/R).
const static t_turn_param_table slalom_outL45_1800_table = {1.80f, 55.0f,23.63,23.69, 45.0f,Turn_L};
const static t_turn_param_table slalom_outR45_1800_table = {1.80f,-55.0f,23.63,23.69,-45.0f,Turn_R};
#else
...
#if PARAM_A_USE_PINK_LED_TURN_LENGTHS
// Pink LED interval (20260725 Lstart=Lend=0 videos, R median copied to L/R).
const static t_turn_param_table slalom_inL135_1800_table = {1.80f, 40.0f,10.88,34.56, 135.0f,Turn_L};
const static t_turn_param_table slalom_inR135_1800_table = {1.80f,-40.0f,10.88,34.56,-135.0f,Turn_R};
#else
...
#if PARAM_A_USE_PINK_LED_TURN_LENGTHS
// Pink LED interval (20260725 Lstart=Lend=0 videos, R median copied to L/R).
const static t_turn_param_table slalom_outL135_1800_table = {1.80f, 41.0f,8.60,45.97, 135.0f,Turn_L};
const static t_turn_param_table slalom_outR135_1800_table = {1.80f,-41.0f,8.60,45.97,-135.0f,Turn_R};
#else
