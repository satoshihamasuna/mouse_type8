...
const static t_pid_gain sp_gain_turn90_700 = {2.00,0.05,0.0};
...
const static t_pid_gain sp_gain_turn180_700 = {2.00,0.05,0.0};
...
const static t_pid_gain sp_gain_turnV90_700 = {2.00,0.05,0.0};
...
const static t_pid_gain sp_gain_turnIn45_700 = {2.00,0.05,0.0};
...
const static t_pid_gain sp_gain_turnOut45_700 = {2.00,0.05,0.0};
...
const static t_pid_gain sp_gain_turnIn135_700 = {2.00,0.05,0.0};
...
const static t_pid_gain sp_gain_turnOut135_700 = {2.00,0.05,0.0};
