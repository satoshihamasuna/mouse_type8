...
const static t_pid_gain sp_gain_turn90_1200 = {1.0,0.06,0.0};
...
const static t_pid_gain sp_gain_turn180_1200 = {1.0,0.06,0.0};
...
//not adjust
const static t_pid_gain sp_gain_turnV90_1200 = {1.0,0.06,0.0};
...
const static t_pid_gain sp_gain_turnIn45_1200 = {1.0,0.06,0.0};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_1200 = {1.0,0.06,0.0};
...
const static t_pid_gain sp_gain_turnIn135_1200 = {1.0,0.06,0.0};
...
//
const static t_pid_gain sp_gain_turnOut135_1200 = {1.0,0.06,0.0};
