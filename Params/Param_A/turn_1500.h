...
//k = 250
const static t_pid_gain sp_gain_turn90_1500 = {2.0,0.016,0.00};
const static t_pid_gain om_gain_turn90_1500 = {0.20,0.01,0.0};
...
const static t_pid_gain sp_gain_turn180_1500 = {2.0,0.016,0.00};
const static t_pid_gain om_gain_turn180_1500 = {0.20,0.01,0.0};
...
//k = 400
//not adjust
const static t_pid_gain sp_gain_turnV90_1500 = {2.0,0.016,0.00};
const static t_pid_gain om_gain_turnV90_1500 = {0.20,0.01,0.0};
...
//k = 300
const static t_pid_gain sp_gain_turnIn45_1500 = {2.0,0.016,0.00};
const static t_pid_gain om_gain_turnIn45_1500 = {0.20,0.01,0.0};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_1500 = {2.0,0.016,0.00};
const static t_pid_gain om_gain_turnOut45_1500 = {0.20,0.01,0.0};
...
//k = 250 , Kp = 4.0
const static t_pid_gain sp_gain_turnIn135_1500 = {2.0,0.016,0.00};
const static t_pid_gain om_gain_turnIn135_1500 = {0.20,0.01,0.0};//{0.7f, 0.7f, 0.0f};
...
//
const static t_pid_gain sp_gain_turnOut135_1500 = {2.0,0.016,0.00};
const static t_pid_gain om_gain_turnOut135_1500 = {0.20,0.01,0.0};
