...
const static t_turn_param_table slalom_inL45_1600_table = {1.60f, 55.0f,7.52,39.62+10.0, 45.0f,Turn_L,0.0f};
const static t_turn_param_table slalom_inR45_1600_table = {1.60f,-55.0f,7.52,39.62+10.0,-45.0f,Turn_R,0.0f};
