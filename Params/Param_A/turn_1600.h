...
//k = 250
const static t_pid_gain sp_gain_turn90_1600 = {2.0,0.05,0.0};
const static t_pid_gain om_gain_turn90_1600 = {0.08,0.002,0.0};
...
//k = 250
const static t_pid_gain sp_gain_turn180_1600 ={4.0,0.10,0.0};
const static t_pid_gain om_gain_turn180_1600 ={0.08,0.002,0.0};
...
//k = 250
const static t_pid_gain sp_gain_turnV90_1600 = {1.0,0.05,0.0};
const static t_pid_gain om_gain_turnV90_1600 = {0.08,0.002,0.0};
...
const static t_turn_param_table slalom_LV90_1600_table = {1.60f, 40.0f,4.79,24.95-10.0, 90.0f,Turn_L};
const static t_turn_param_table slalom_RV90_1600_table = {1.60f,-40.0f,4.79,24.95-10.0,-90.0f,Turn_R};
...
//k = 250
const static t_pid_gain sp_gain_turnIn45_1600 = {1.0,0.05,0.0};
const static t_pid_gain om_gain_turnIn45_1600 = {0.08,0.002,0.0};
...
//k = 250
const static t_pid_gain sp_gain_turnOut45_1600 = {1.0,0.05,0.0};
const static t_pid_gain om_gain_turnOut45_1600 = {0.08,0.002,0.0};
...
//k = 250,alpha = 1.0
const static t_pid_gain sp_gain_turnIn135_1600 = {1.0,0.05,0.0};
const static t_pid_gain om_gain_turnIn135_1600 = {0.08,0.002,0.0};//{0.7f, 0.7f, 0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turnOut135_1600 = {1.0,0.05,0.0};
const static t_pid_gain om_gain_turnOut135_1600 = {0.08,0.002,0.0};
