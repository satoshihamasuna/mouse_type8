...
//k = 250
const static t_pid_gain sp_gain_turn90_1600 = {4.0,0.1,0.0};
const static t_pid_gain om_gain_turn90_1600 = {0.10f,0.01f,0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turn180_1600 ={4.0,0.1,0.0};
const static t_pid_gain om_gain_turn180_1600 = {0.10f,0.01f,0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turnV90_1600 = {4.0,0.1,0.0};
const static t_pid_gain om_gain_turnV90_1600 = {0.10f,0.01f,0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turnIn45_1600 = {4.0,0.1,0.0};
const static t_pid_gain om_gain_turnIn45_1600 = {0.10f,0.01f,0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turnOut45_1600 = {4.0,0.1,0.0};
const static t_pid_gain om_gain_turnOut45_1600 = {0.10f,0.01f,0.0f};
...
//k = 250,alpha = 1.0
const static t_pid_gain sp_gain_turnIn135_1600 = {4.0,0.1,0.01};
const static t_pid_gain om_gain_turnIn135_1600 = {0.10f,0.01f,0.0f};//{0.7f, 0.7f, 0.0f};
...
//k = 250
const static t_pid_gain sp_gain_turnOut135_1600 = {4.0,0.1,0.0};
const static t_pid_gain om_gain_turnOut135_1600 = {0.10f,0.01f,0.0f};
