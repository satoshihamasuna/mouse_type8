...
const static t_pid_gain om_gain_turn90_2000 = {0.10f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turn180_2000 = {0.10f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnV90_2000 = {0.10f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnIn45_2000 = {0.10f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnOut45_2000 = {0.10f,0.01f,0.0f};
...
const static t_pid_gain om_gain_turnIn135_2000 = {0.10f,0.01f,0.0f};//{0.7f, 0.7f, 0.0f};
...
const static t_pid_gain om_gain_turnOut135_2000 = {0.10f,0.01f,0.0f};
