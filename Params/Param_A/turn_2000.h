...
const static t_ff_gain ff_gain_long_turn_90_R_2000 = {
	0.9030126f, 0.08183161f, 0.1190275f, 0.0168f, 0.00094f, 0.00092f, 0.0613f, 0.0000032f
};
const static t_ff_gain ff_gain_long_turn_90_L_2000 = {
	0.9030126f, 0.08183161f, 0.1190275f, 0.0168f, 0.00098f, 0.00091f, 0.0175f, 0.0000029f
};
const static t_ff_gain ff_gain_long_turn_180_R_2000 = {
	0.9030126f, 0.08101898f, 0.2138578f, 0.0168f, 0.00088f, 0.00094f, 0.0613f, 0.0000032f
};
const static t_ff_gain ff_gain_long_turn_180_L_2000 = {
	0.9030126f, 0.08101898f, 0.2138578f, 0.0168f, 0.00094f, 0.00086f, 0.0175f, 0.0000029f
};
