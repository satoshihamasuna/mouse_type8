...
const static t_turn_param_table slalom_L90_1600_table = {1.60f, 52.0f,14.95,34.50, 90.0f,Turn_L};
const static t_turn_param_table slalom_R90_1600_table = {1.60f,-52.0f,14.95,34.50,-90.0f,Turn_R};
...
const static t_turn_param_table slalom_L180_1600_table = {1.60f,  48.0f,(11.03),(33.15), 180.0f,Turn_L};
const static t_turn_param_table slalom_R180_1600_table = {1.60f, -48.0f,(11.03),(33.15),-180.0f,Turn_R};
...
const static t_pid_gain om_gain_turnIn45_1600 = {0.4, 0.02, 0.0};
...
const static t_pid_gain om_gain_turnOut45_1600 = {0.4, 0.02, 0.0};
...
const static t_turn_param_table slalom_inL135_1600_table = {1.60f, 42.0f,12.55,26.84, 135.0f,Turn_L};
const static t_turn_param_table slalom_inR135_1600_table = {1.60f,-42.0f,12.55,26.84,-135.0f,Turn_R};
