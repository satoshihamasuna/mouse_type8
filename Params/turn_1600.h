...
const static t_pid_gain om_gain_turn90_1600 = {0.15, 0.01, 0.01};
...
const static t_pid_gain om_gain_turn180_1600 = {0.2, 0.01, 0.01};
...
const static t_pid_gain om_gain_turnV90_1600 = {0.30, 0.02, 0.01};
...
const static t_pid_gain om_gain_turnIn45_1600 = {0.30, 0.02, 0.01};
...
const static t_pid_gain om_gain_turnOut45_1600 = {0.30, 0.02, 0.01};
...
const static t_pid_gain om_gain_turnIn135_1600 = {0.25, 0.02, 0.01};//{0.7f, 0.7f, 0.0f};
...
const static t_pid_gain om_gain_turnOut135_1600 = {0.25, 0.02, 0.01};
