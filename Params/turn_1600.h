...
const static t_pid_gain om_gain_turn90_1600 = {0.35, 0.02, 0.0};
...
const static t_pid_gain om_gain_turn180_1600 = {0.35, 0.02, 0.0};
const static t_turn_param_table slalom_L180_1600_table = {1.60f, 45.0f,8.80,30.10, 180.0f,Turn_L};
const static t_turn_param_table slalom_R180_1600_table = {1.60f,-45.0f,8.80,30.10,-180.0f,Turn_R};
...
const static t_pid_gain om_gain_turnV90_1600 = {0.35, 0.02, 0.0};
...
const static t_pid_gain om_gain_turnIn45_1600 = {0.35, 0.02, 0.0};
...
const static t_pid_gain om_gain_turnOut45_1600 = {0.35, 0.02, 0.0};
...
const static t_pid_gain om_gain_turnIn135_1600 = {0.35, 0.02, 0.0};//{0.7f, 0.7f, 0.0f};
...
const static t_pid_gain om_gain_turnOut135_1600 = {0.35, 0.02, 0.0};
